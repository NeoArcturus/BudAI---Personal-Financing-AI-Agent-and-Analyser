...
from agents.intelligence.Scenario_Agent.ScenarioAgent import ScenarioAgent
...
async def call_scenario_agent(
    ...
    result = await agent.app.ainvoke({"messages": [{"role": "user", "content": query_with_context}], "user_uuid": user_uuid})
