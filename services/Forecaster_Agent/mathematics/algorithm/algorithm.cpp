...
vector<vector<double>> heston_jump_mc(HestonParams hp, JumpParams jp, double mu, double dt, int days, int paths, int seed, const double* deterministic_calendar)
{
