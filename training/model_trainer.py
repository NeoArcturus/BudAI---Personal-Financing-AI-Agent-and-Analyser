...
class CategorizerTrainer:
    ...
    def train(self):
        ...
        embeddings = self.sentence_model.encode(clean_df['Description'].tolist(), show_progress_bar=True)
        ...
        if rare_classes:
            print(f"Detected {len(rare_classes)} rare categories. Adjusting data for training...")
            X_extra = []
            y_extra = []
